...
public class RoulettePostHandlerV2 implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            RouletteRequestV2 request = gson.fromJson(reader, RouletteRequestV2.class);
            reader.close();
           ...
           boolean esitoVittoria = RouletteServiceV2.logicaDiCalcolo(request.getGiocata(), request.getNumero());
            // Crea l'oggetto risposta DA FARE
            RouletteResponseV2 response = new RouletteResponseV2(
                request.getGiocata(),
                request.getNumero(),
 ...
 private boolean validazioneParametri(RouletteRequestV2 request) {
